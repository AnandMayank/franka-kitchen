...
class Agent(object):
    ...
    def train(self, env , memory:ReplayBuffer, episodes=1000 , batch_size = 64, updates_per_steps = 1, summary_writer_name="" , max_episode_steps = 100):
        ...
        for episode in range(episodes):
            ...
            while not done and episode_steps < max_episode_steps:
                ...
                if memory.can_sample(batch_size= batch_size):
                    for i in range(updates_per_steps):
